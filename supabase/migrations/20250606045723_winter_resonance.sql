/*
  ...
  1. Tables Created
    - sources (for storing uploaded content sources)
    - chunks (for storing text chunks with embeddings)
    - threads (for grouping related chunks)
    - micro_threads (for storing follow-up conversations)
    - models (for LLM configuration)
